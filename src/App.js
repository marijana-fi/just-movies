...
class App extends React.Component {
   ...
   addToFavorites = movie => {
      this.setState({ favorites: [...this.state.favorites, movie] }, () => {
         localStorage.setItem("movies", JSON.stringify(this.state.favorites));
      });
   ...
   handleLoadMore = () => {
      ...
      this.setState(
         ...
         () => {
            ...
            api.loadMore(activePath, searchQuery, page, activeGenre).then(data =>
               this.setState({
            ...
            <Provider value={this.state}>
               <Router>
                  ...
                  <GenreResults
                     ...
                     setSort={this.setSort}
                  />
                  <SearchResults path="/search" data={this.state} handleLoadMore={this.handleLoadMore} />
                  <Favorites
                     path="/favorites"
                     data={this.state}
                     loadFavoritesFromLocalStorage={this.loadFavoritesFromLocalStorage}
                     resetGenreName={this.resetGenreName}
                     setActivePath={this.setActivePath}
                  />
               </Router>
