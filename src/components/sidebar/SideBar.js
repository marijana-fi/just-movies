...
class SideBar extends React.Component {
   ...
   handleSelectChange = genre => {
      ...
      this.props.getGenre(genre.value, genre.label, this.state.defaultSort.value);
      this.props.toggleMenu();
   ...
   render() {
      ...
      return this.state.loading ? (
         ...
         <>
            <aside className={`sidebar ${this.props.isMenuVisible ? "show-sidebar" : ""}`}>
               <Link to="/">
                  <div
                     className="logo-wrap"
                     onClick={() => {
               ...
               <ul className="side-list">
                  <Link to="/top_rated">
                     <li
                        className={`list-item ${path === "movie/top_rated" ? "active" : ""}`}
                        onClick={() => {
                  ...
                  <Link to="/upcoming">
                     <li
                        className={`list-item ${path === "movie/upcoming" ? "active" : ""}`}
                        onClick={() => {
                  ...
                  <Link to="/favorites">
                     <li
                        className={`list-item ${path === "movie/favorites" ? "active" : ""}`}
                        onClick={() => {
                           this.handleLinkClick("movie/favorites");
                        }}
                     >
                        <div className="favorites">{this.props.data.favorites.length}</div>
                        Favorites
                     </li>
                  </Link>
               </ul>
               <Select
                  ...
                  className={`select ${this.props.data.activeGenreName !== "Select genre" ? "active" : ""}`}
            ...
            <div
               className={`overlay ${this.props.isMenuVisible ? "show-overlay" : ""}`}
